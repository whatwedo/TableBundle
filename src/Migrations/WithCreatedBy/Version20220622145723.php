...
namespace whatwedo\TableBundle\Migrations\WithCreatedBy;

use Doctrine\DBAL\Schema\Schema;
use Doctrine\Migrations\AbstractMigration;

final class Version20220622145723 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'creates "whatwedo_table_filter" table (with created by)';
    }
